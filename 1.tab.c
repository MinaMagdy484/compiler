...
static const yytype_uint8 yyprhs[] =
{
      ...
      80,    86,    92,    97,   102,   110,   122,   132,   142,   152,
     162,   164,   166,   170,   174,   178,   182,   186,   190,   194,
     198,   202,   207,   212,   215
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      26,    -1,    14,    28,     8,    30,     7,    29,    25,    38,
      26,    -1,    14,    28,     7,    30,     8,    29,    25,    38,
...
static const yytype_uint8 yydefact[] =
{
      ...
      34,    40,    39,    32,    33,    37,    38,     0,    16,    17,
      14,    15,    18,    19,    20,    21,     9,    12,     0,     0,
       0,     0,    41,    42,     0,     0,     0,     0,     0,    24,
       0,     0,     0,     0,     0,     0,     0,     0,     0,     9,
      26,    29,    28,    27,     0,    25
};
...
{
       5,   -11,    22,   -85,   -85,    -2,    24,    32,    41,   -85,
       7,    43,    60,    62,    29,    27,    40,    72,   -85,   -85,
     -85,   -85,   -85,   -85,   -85,     2,     1,    -5,    90,   101,
       2,     2,    45,   -85,   -85,     2,     2,     2,    42,    94,
     116,    96,   121,   111,   130,    59,    76,   119,   120,   113,
      93,   110,   107,     2,     2,     2,     2,     2,     2,     2,
     -85,     2,   135,   125,   126,   -85,   127,   128,   -85,   129,
     131,   133,   134,   137,   136,   132,   139,   -85,     2,   113,
     113,   113,   113,    89,    89,    89,   110,     2,   -85,   -85,
     -85,   -85,   -85,   -85,   -85,   -85,   -85,   -85,   138,   140,
     141,   142,   110,   110,    28,   143,   147,   148,   149,   154,
      58,    58,    58,    58,   150,   151,   152,   153,   155,   -85,
     -85,   -85,   -85,   -85,    30,   -85
};
...
{
      45,    46,     6,     7,     8,    49,    50,    51,     1,    33,
      34,    41,   104,    42,     3,    14,    15,    39,    40,    35,
      16,    17,     4,    79,    80,    81,    82,    83,    84,    85,
      36,    86,    11,    18,    37,   124,    14,    15,    14,    15,
      12,    16,    17,    16,    17,    25,    26,    27,   102,    13,
      28,    29,    47,    48,   109,    30,   125,   103,    52,    53,
      54,    55,    56,    57,    58,    59,    14,    15,    31,    60,
      22,    16,    17,    61,    62,    52,    53,    54,    55,    56,
      57,    58,    59,   115,   116,   117,   118,    23,    73,    24,
      61,    62,    52,    53,    54,    55,    56,    57,    58,    59,
      32,    63,    64,    66,    67,    74,    43,    61,    62,    52,
      53,    54,    55,    56,    57,    58,    59,    44,    69,    70,
      61,    62,    77,    78,    61,    62,    52,    53,    54,    55,
      56,    57,    58,    59,    57,    58,    59,    71,    72,    98,
      99,    61,    62,    65,    61,    62,   100,   101,    68,    75,
      76,    87,    88,    89,    90,    91,    92,     0,    93,     0,
      94,    95,    96,    97,   114,     0,     0,   105,   110,   106,
     107,   108,   111,   112,   113,   119,     0,   120,   121,   122,
       0,   123
};

static const yytype_int8 yycheck[] =
{
      30,    31,     4,     5,     6,    35,    36,    37,     3,     7,
       8,    16,    96,    18,    25,     8,     9,    16,    17,    17,
      13,    14,     0,    53,    54,    55,    56,    57,    58,    59,
      28,    61,     8,    26,    32,   119,     8,     9,     8,     9,
       8,    13,    14,    13,    14,    16,    17,    18,    78,     8,
      21,    22,     7,     8,    26,    28,    26,    87,    16,    17,
      18,    19,    20,    21,    22,    23,     8,     9,    28,    27,
      27,    13,    14,    31,    32,    16,    17,    18,    19,    20,
      21,    22,    23,   110,   111,   112,   113,    27,    29,    27,
      31,    32,    16,    17,    18,    19,    20,    21,    22,    23,
      28,     7,     8,     7,     8,    29,    16,    31,    32,    16,
      17,    18,    19,    20,    21,    22,    23,    16,     7,     8,
      31,    32,    29,    16,    31,    32,    16,    17,    18,    19,
      20,    21,    22,    23,    21,    22,    23,     7,     8,     7,
       8,    31,    32,    27,    31,    32,     7,     8,    27,    30,
      30,    16,    27,    27,    27,    27,    27,    -1,    27,    -1,
      27,    27,    25,    27,    10,    -1,    -1,    29,    25,    29,
      29,    29,    25,    25,    25,    25,    -1,    26,    26,    26,
      -1,    26
};
...
static const yytype_uint8 yystos[] =
{
      ...
      27,    27,    27,    27,    27,    27,    25,    27,     7,     8,
       7,     8,    41,    41,    37,    29,    29,    29,    29,    26,
      25,    25,    25,    25,    10,    38,    38,    38,    38,    25,
      26,    26,    26,    26,    37,    26
};
...
#line 360 "1.y"
    {
	                                                int i;
	                                                fprintf(yyout,"\nWHILE Loop Found\n");
	                                                for(i=sym[(yyvsp[(3) - (9)])] ; i<(yyvsp[(5) - (9)]) ; i++) 
                                                        {
                                                                fprintf(yyout,"%dth Loop: \n", i);
                                                        };}
    break;
...
#line 367 "1.y"
    {
	                                                int i;
	                                                fprintf(yyout,"\nWHILE Loop Found\n");
	                                                for(i=(yyvsp[(3) - (9)]) ; i<sym[(yyvsp[(5) - (9)])] ; i++) 
                                                        {
                                                                fprintf(yyout,"%dth Loop: \n", i);
                                                        };}
    break;
